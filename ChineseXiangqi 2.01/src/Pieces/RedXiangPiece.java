...
public class RedXiangPiece extends Piece
{
    Board board;

    public RedXiangPiece(Board board,int rows,int cols)
    {
        this.board=board;
    ...
    {
        image = new Image(getClass().getResourceAsStream("/Xiang/elephant_red.png"));
    }
