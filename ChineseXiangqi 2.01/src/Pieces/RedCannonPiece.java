...
public class RedCannonPiece extends Piece {

    Board board;

    public RedCannonPiece(Board board , int rows, int cols) {
    ...
    public void getPlayerImage() {
        ...
        image = new Image(getClass().getResourceAsStream("/Cannon/cannon_red.png"));
