...
public class BlackHorsePiece extends Piece {
    Board board;


    public BlackHorsePiece(Board board , int rows, int cols) {
    ...
    public void getPlayerImage() {
        ...
        image = new Image(getClass().getResourceAsStream("/Horse/horse_black.png"));
    ...
    public int[][] getPst()
    {
        return tool.verticleInverse(Ai.HORSE_PST);
    }
}
