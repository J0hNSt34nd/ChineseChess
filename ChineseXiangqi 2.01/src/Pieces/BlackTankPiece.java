...
public class BlackTankPiece extends Piece
{
    Board board;
    //构造器
    public BlackTankPiece(Board board,int rows,int cols)
    {
        this.board=board;
    ...
    {
        image= new Image(getClass().getResourceAsStream("/Tank/chariot_black.png"));
    }
    ...
    public int[][] getPst()
    {
        return tool.verticleInverse(Ai.CHARIOT_PST);
    }
}
